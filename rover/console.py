...
FIELD_HELP = {
    ...
    "peerUdp.autoRestartOnMissingPeerDistanceSec": "Seconds of missing fresh peer distance before exiting so systemd restarts the rover. Use 0 to disable.",
    "peerUdp.autoRestartStartupGraceSec": "Seconds after startup before the missing-peer-distance restart watchdog starts counting.",
    "peerUdp.autoRestartCheckIntervalSec": "Seconds between missing-peer-distance watchdog checks.",
